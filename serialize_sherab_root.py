...
def serialize_bo_translations():
    ...
    for translation_name, content in res.items():
        title_on_pecha  = TITLE_MAP[translation_name]
        book_metadata = {
    ...
    write_json("jsons/sherab/root/sherab_translations.json", bo_json)
            

if __name__ == "__main__":
    serialize_bo_translations()
